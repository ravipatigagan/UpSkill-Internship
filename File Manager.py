...
def copy_file():
    ...
    mb.showinfo('Success', "File Copied !")
...
def delete_file():
    ...
    if os.path.exists(del_file):
        os.remove(del_file)
        mb.showinfo('Success', "File Deleted !")           
    else:
        mb.showinfo('Error', "File not found !")
...
def rename_file():
    ...
    mb.showinfo('Success', "File Renamed !")
...
def move_file():
    ...
    if(source==destination):
        mb.showinfo('Error', "Source and destination are same")
    else:
        shutil.move(source, destination)  
        mb.showinfo('Success', "File Moved !")
...
def make_folder():
    ...
    os.mkdir(path)
    mb.showinfo('Success', "Folder created !")

# function to remove a folder
def remove_folder():
    delFolder = filedialog.askdirectory()
    os.rmdir(delFolder)
    mb.showinfo('Error', "Folder Deleted !")
...
Label(root, text="File Manager", font=("Times", 16), fg="blue").grid(row = 5, column = 2)
